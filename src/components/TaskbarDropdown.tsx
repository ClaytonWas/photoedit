...
function TaskbarDropdown({ title, items }: TaskbarDropdownProps) {
    ...
    return (
        <div className="relative w-12 text-sm text-[var(--text)] my-1 ml-2 md:w-24 md:text-lg cursor-pointer">
            <button
                className="w-full text-left border border-[var(--accent)] rounded-t bg-[var(--taskbar-indent)] hover:border-[var(--accent)] hover:bg-[var(--taskbar-hover)] pl-2"
